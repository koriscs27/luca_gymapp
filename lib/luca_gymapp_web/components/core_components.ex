defmodule LucaGymappWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LucaGymappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LucaGymappWeb.Gettext, "errors", msg, opts)
    end
  end
